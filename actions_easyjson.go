...
func easyjsonB97b45a3EncodeGithubComSoniricoGoHyperliquid21(out *jwriter.Writer, in MultiSigAction) {
	...
	}
	{
		...
		if in.Action == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v9First := true
			for v9Name, v9Value := range in.Action {
				if v9First {
					v9First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Signatures == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v12, v13 := range in.Signatures {
				if v12 > 0 {
					out.RawByte(',')
				}
